    ...
    if (usertemp.email) {
      if (!String(usertemp.email).includes("@")) {
        ...
        axios
          ...
          .catch((err) => {
            alert("Email chưa từng được đăng ký!!!");
          });
      }
    } else {
      alert("Vui lòng nhập đầy đủ các trường!");
        ...
        <div className="reqpass">
          ...
          >
            <div className="reqpass-email login-login">
              <input
                ...
                class="login-input"
                name="username"
                onChange={(event) => setusertemp({ email: event.target.value })}
              ></input>
            </div>
            <div className="reqpass-act-button">
              <button
                class="button reqpass-button"
                onClick={(e) => handleClickReqPass(e)}
              >
                Xác nhận
              </button>
              <button
                class="button reqpass-cancel-button"
                onClick={() => showLogin()}
              >
                Hủy
              </button>
          ...
          <div className={reqsdt === true ? "reqsdt-form" : "reqsdt-form-hide"}>
            <div className="reqpass-email login-login">
              <input
                ...
                class="login-input"
                name="sdt"
                onChange={(event) => setusertemp({ sdt: event.target.value })}
              ></input>
            </div>
            <div className="reqpass-act-button">
              <button
                class="button reqpass-button"
                onClick={() => handleClickReqSdt()}
              >
                Xác nhận
              </button>
              <button
          ...
          <div className={reqpass2 === true ? "reqpass2" : "reqpass2-hide"}>
            <input
              ...
              class="login-input-pass2"
              onChange={(event) =>
                setusertemp({ ...usertemp, pass: event.target.value })
              }
            ></input>
            <input
              type="password"
            ...
            ></input>
            <button
              className="button reqpass-pass2-button"
              onClick={(e) => handleClickReqPass2(e)}
            >
              Xác nhận
            </button>
          </div>
          ...
          <div>
            <div className="firstname login-login">
              <input
                ...
                name="firstname"
                onChange={(event) =>
                  setusertemp({ ...usertemp, firstname: event.target.value })
                }
              ></input>
            </div>
            <div className="lastname login-login">
              <input
                ...
                name="firstname"
                onChange={(event) =>
                  setusertemp({ ...usertemp, lastname: event.target.value })
                }
              ></input>
            </div>
            <div className="username login-login">
              <input
                ...
                placeholder="Email"
                className={
                  flag === true ? "login-input-warning" : "login-input"
                }
                name="username"
            ...
            <div className="password2 login-login">
              <input
                ...
                className={
                  flag2 === true ? "login-input-warning" : "login-input"
                }
                onChange={(event) => setpass2(event)}
              ></input>
            </div>
            <div className="sdt login-login">
              <input
                ...
                class="login-input"
                onChange={(event) =>
                  setusertemp({ ...usertemp, sdt: event.target.value })
                }
              ></input>
            </div>
            <div className="address login-login">
              <input
                ...
                class="login-input"
                onChange={(event) =>
                  setusertemp({ ...usertemp, diachi: event.target.value })
                }
              ></input>
            </div>
            <button
